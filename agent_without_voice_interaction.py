...
class QuizApp:
    def __init__(self, master):
        ...
        self.questions = [
            ...
            },
            {
                ...
                "options": ["AlphaGo", "DeepBlue", "AlphaStar", "StarCrafter"],
                "answer": "AlphaStar",
                "image" : None
            },
            {
        ...
        self.available_roll_numbers = [num for num in range(34, 98) if num not in {50, 70, 77}]
        ...
        self.timer_label = tk.Label(master, text="Time left: 15", font=("Arial Black", 20), fg="#ff3333", bg="#1c1c1c")
        ...
        self.answer_button = tk.Button(master, text="✔ Submit Answer", font=("Arial Black", 10), command=self.check_answer, bg="#009933", fg="white", relief="groove", padx=20, pady=10)
        
        # self.answer_button.pack_forget()

        self.start_button = tk.Button(master, text="🎲 Start Quiz", font=("Arial Black", 14), command=self.start_quiz, bg="#3366cc", fg="white", relief="groove", padx=20, pady=10)
    ...
    def rules(self):
        message = (
        """
        Welcome to this Quiz Game! Get ready for a fair and thrilling challenge where luck and knowledge go hand in hand. 
        Press the "Start Quiz" button to begin. A random roll number will be selected, and if it's yours, you must stand up. 
        You will then be asked a question and have 15 seconds to answer. Press the "Check Answer" button to lock in your choice. 
        If time runs out, the next question will be asked automatically, and what fun is there when there in no rewards, so to make 
        things even more exciting, every correct answer earns a cash prize of Rs. 10 at the end of the game. 
        Stay sharp, play fair, and best of luck!
        """
        )
    ...
    def suspense_roll_picker(self, steps=15, delay=100):
        ...
        if steps > 0:
            ...
            self.master.after(7000, self.ask_question)
